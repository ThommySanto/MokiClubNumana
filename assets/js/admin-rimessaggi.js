(function () {
    ...
    function initSignaturePreviewToggle() {
        var buttons = document.querySelectorAll('.toggle-rimessaggio-signature-preview');
    ...
    function initDeleteConfirm() {
        var deleteLinks = document.querySelectorAll('.rimessaggi-delete-action[data-confirm-message]');
